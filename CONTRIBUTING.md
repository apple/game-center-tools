...
Thanks for your interest in contributing. This project was released to provide an example for game developers using the App Store Connect API, and beyond its publication there are limited plans for future development of the repository.
